Rails.application.configure do
  ...
  # ActionMailer::Previewを本番で使えるように指定
  if ENV['ACTION_MAILER_PREVIEW_AVAILABLE'] == 'true'
  ...
  config.action_mailer.default_url_options = { host: ENV['MAIL_DEFAULT_HOST'], protocol: (ENV['MAIL_DEFAULT_PROTOCOL'] || 'https') }
